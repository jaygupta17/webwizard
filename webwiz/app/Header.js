...
function Header() {
  ...
  return (
    <div className="md:h-[13vh] h-[20vh] w-full flex justify-center items-center">
      <div className="bg-white/10 md:h-[10vh] w-[100%] rounded-[20px] flex justify-between items-center min-[200px]:h-[20vh] min-[200px]:flex-row min-[700px]:flex-row relative">
        ...
        >
          ...
          <div className="md:w-[30%] h-[100%] flex justify-center items-center sm:w-full gap-2 ml-[20%]">
          <UserButton/>
          <Link href="/support">

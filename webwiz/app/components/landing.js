        ...
        >
          ...
          <div className="h-[100%] w-[100%] bg-gradient-to-b from-transparent from-[25%] via-black/50 via-[45%] to-black/60 flex justify-center items-center flex-col">
            <div className="flex justify-center w-full items-center flex-col">
              <div
                className="text-[10vh] max-[440px]:text-[5vh] w-full font-bold sans-serif flex justify-center items-center font-[Irish Grover, system-ui] text-justify"
                style={{ color: "#F9FB6B" }}
              >
                Web Wizard
              </div>
              <div className="text-xl text-center text-white w-1/2 mx-auto flex justify-center align-center">

...
export default function mid() {
    return (
        <div className='h-[150vh] max-[700px]:h-[400vh] w-[100%] flex justify-center items-center flex-col max-[700px]:gap-y-4'>
            <div className='w-[50%] h-[70vh] flex justify-center items-center max-[700px]:h-[190vh] max-[700px]:w-[90%] max-[700px]:flex-col '>
                ...
                <Spline className='max-[700px]:w-[100%] max-[700px]:h-[90vh] w-[20%]' scene="https://prod.spline.design/xEAdY-lDDdB-dcVo/scene.splinecode" />
            </div>
            <div className='flex-row-reverse w-[50%] h-[70vh] max-[700px]:h-[190vh] max-[700px]:w-[90%] flex justify-center items-center max-[700px]:flex-col max-[700px]:w-[80%]'>

...
export default function mid() {
    return (
        <div className='h-[150vh] w-[100%] flex justify-center items-center flex-col'>
            <div className='w-[50%] h-[70vh] flex justify-center items-center  max-[700px]:flex-col'>
                <div className='w-[70%] max-[700px]:w-[80%]'>
            ...
            <br></br>
            <div className='flex-row-reverse w-[50%] h-[70vh] flex justify-center items-center max-[700px]:flex-col max-[700px]:w-[80%]'>
                <div className='w-[70%] max-[700px]:w-[80%]'>

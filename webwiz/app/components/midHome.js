...
export default function mid() {
    return (
        <div className='h-[150vh] w-[100%] flex justify-center items-center flex-col'>
            <div className='w-[80%] h-[70vh] flex justify-center items-center gap-18 max-[700px]:flex-col '>
                <div className='w-[70%] max-[700px]:w-[80%] ml-[8%]'>
                    <h2 className='text-white text-[35px] font-[Cinzel] text-5xl mt-16 '>The Wizards Home</h2>
                ...
                <Spline className='mt-[9%]' scene="https://prod.spline.design/xEAdY-lDDdB-dcVo/scene.splinecode" />
            </div>
            <br></br>
            <div className='flex-row-reverse w-[65%] h-[70vh] flex justify-center items-center gap-18 max-[700px]:flex-col max-[700px]:w-[80%]'>
                <div className='w-[85%] max-[700px]:w-[80%] mr-[8%]'>
